...
export default function S3Guide(props) {
    ...
    return (
        <div>
            <Typography variant={"h6"}>{props.policy ? "修改" : "添加"} S3 存储策略</Typography>
            ...
            {activeStep === 0 && (
                ...
                >
                    ...
                    <div className={classes.subStepContainer}>
                        ...
                        <div className={classes.subStepContent}>
                            <Typography variant={"body2"}>
                                在使用 S3 储策略前，请确保您在配置文件中正确进行了 CORS 跨域设置。
                            </Typography>
                        </div>
                    </div>
                    ...
                    <div className={classes.subStepContainer}>
                        ...
                        <div className={classes.subStepContent}>
                            <Typography variant={"body2"}>
                                填写兼容实现名称，天翼云 OOS 请填写<code>ctyun</code>
                            </Typography>
                            <div className={classes.form}>
                                <FormControl fullWidth>
                                    <InputLabel htmlFor="component-helper">
                    ...
                    <div className={classes.subStepContainer}>
                        <div className={classes.stepNumberContainer}>
                            <div className={classes.stepNumber}>{getNumber(8,[
                                useCDN === "true"
                            ])}</div>
                        </div>
                        <div className={classes.subStepContent}>
